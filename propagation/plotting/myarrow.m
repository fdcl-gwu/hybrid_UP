function [h] = myarrow(p1,p2,acolor,lwidth,alength,awidth)
% acolor=[0 0 1];
% alength=1;
% awidth=1;
% lwidth=1;
...
h.a=patch('Vertices',vertice,'Faces',faces,'FaceColor',acolor,'LineStyle','none');
h.l=line([p1(1) origin(1)],[p1(2) origin(2)],[p1(3) origin(3)],'Color',acolor,'LineWidth',lwidth);
h.alength = alength;
h.awidth = awidth;
end